...
public class Q18 {
    public static void main(String[] args) {
        ...
        if (vize < 0 || fnal < 0) {//- deger girme kontrolu yapıldı
            ...
            if (gecmeNotu >= 90) {
                System.out.println("agam tebrikler kim copy verdiyse gayet başarılı AA");
                ...
                System.out.println("ucuz yırttın DD ");
            } else System.out.println("agam maalesef çoook BASARISIZSIN hiç mi copy veren olmadı çaktın  :(");
        }
    }
}
