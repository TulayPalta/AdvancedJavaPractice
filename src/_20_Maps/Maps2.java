...
public class Maps2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(kisiListesi.get(1548).get("ad") );//mapte get methodu ile value ya kar��l�k gelen mapi getirdi
		
		for (Entry<Integer, HashMap<String, String>> entry : kisiListesi.entrySet())
        {     
			System.out.println("No = " + entry.getKey() + ", Ki�i Bilgileri = " + entry.getValue().get("ad")+ " "+ entry.getValue().get("soyad"));			
        }
